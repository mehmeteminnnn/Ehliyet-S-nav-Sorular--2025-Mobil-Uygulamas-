  ...
  static Test getTest() {
    return Test(
      ...
      questions: [
        Question(
          questionText:
              'Aşağıdakilerden hangisi, kazazedenin ikinci değerlendirilme aşamalarından olan "Baştan Kontrol" basamağında yer alır?',
          options: [
        ...
        Question(
          ...
          options: [
            ...
            'Yara ağzından kalp atımlarına uyumlu şekilde fişkırarak akması'
          ],
          correctAnswer: 'B',
        ),
        Question(
        ...
        Question(
          questionText:
              'Atardamar kanamalarında, kısa zamanda çok kan kaybetmemek için kanayan yer üzerine veya kanayan yere yakın bir üst atardamar bölgesine basınç uygulanır. Buna göre, boyun, koltuk altı, köprücük kemiği üzeri verilenlerden hangileri vücutta bu amaç için belirlenmiş basınç uygulama noktalarındandır?',
        ...
        Question(
          ...
          options: ['Ada', 'Ayrıcı', 'Şerit', 'Banket'],
          correctAnswer: 'B',
        ),
        // 16. Soru (Görsel soru)
        Question(
...
// 26. Soru
        ...
        Question(
          ...
          options: ["30", "50", "70", "80"],
          correctAnswer: "B",
          imageUrl: "assets/images/deneme1-27.png", // Görsel içermiyor
        ),
...
/*final List<Question> test1Questions = [
  
];

final List<Test> allTests = List.generate(
  10,
  (index) => Test(
    testNumber: index + 1,
